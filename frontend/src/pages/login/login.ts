  ...
  container.innerHTML = `
    <div class="min-h-screen bg-neutral-950 text-gray-100">
      ...
      <main class="min-h-[70vh] flex flex-col items-center justify-center px-6">
        <!-- GitHub mark -->
        <div class="rounded-full bg-neutral-800 ring-2 ring-neutral-600 p-4 text-gray-100">
        ...
        <!-- Card -->
        <section class="mt-8 w-full max-w-md rounded-xl bg-neutral-800/60 ring-2 ring-neutral-600 shadow-xl p-6">

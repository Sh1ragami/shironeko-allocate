  ...
  container.innerHTML = `
    <div class="min-h-screen bg-neutral-900 text-gray-100">
      ...
      <main class="min-h-[70vh] flex flex-col items-center justify-center px-6">
        <!-- GitHub mark -->
        <div class="rounded-full bg-neutral-800 ring-1 ring-neutral-700/70 p-4 text-gray-100">
        ...
        <!-- Card -->
        <section class="mt-8 w-full max-w-md rounded-xl bg-neutral-800/60 ring-1 ring-neutral-700/60 shadow-xl p-6">
          ...
          <div class="mt-5 flex justify-center">
            <a href="/api/auth/github" class="inline-flex items-center justify-center rounded-md bg-emerald-600 hover:bg-emerald-500 text-white font-medium px-6 py-2.5 shadow-lg shadow-emerald-900/30 transition-colors">
              ログイン
            </a>
          </div>
        </section>
